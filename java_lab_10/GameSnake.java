...
public class GameSnake extends JFrame {
    ...
    private static GameSnake instance;

    private final JLabel label = new JLabel();
    private final JLabel labelMenu = new JLabel();
    ...
    public static GameSnake getInstance() {
